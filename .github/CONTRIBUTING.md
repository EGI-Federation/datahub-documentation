...
1. A maintainer will review your code and merge it if no changes are necessary. Your change will be merged into the repository's `master` branch and will be noted in the project's changelog at the time of release.
...
master branch is always available at http://egi-datahub.readthedocs.io/en/latest/ 
